...
public class SecurityUtil {
    ...
    // get current user
    public static Optional<ConfirmationToken> getCurrentUser(){
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        if (authentication == null) {
            return Optional.empty();
        } else if (authentication.getPrincipal() instanceof ConfirmationToken) {
            return Optional.ofNullable((ConfirmationToken) authentication.getPrincipal());
        }
...
//            return null;
//        } else if (authentication.getPrincipal() instanceof ConfirmationToken) {
//            ConfirmationToken user = (ConfirmationToken) authentication.getPrincipal();
