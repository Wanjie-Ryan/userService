...
import static com.eclectics.bank.config.Constants.*;
...
public class JWTTokenUtil implements Serializable {
    ...
    public String generateToken(ConfirmationToken user) {
        return doGenerateToken(user);
    }

    private String doGenerateToken(ConfirmationToken user) {
...
//        claims.put("scopes", Arrays.asList(new SimpleGrantedAuthority(user.getUserRole().name())));
        ...
        claims.put("uid", user.getCredentialsId());
